...
extern "C" int PF_GetFirstPage(int fd, int *pagenum, char **pagebuf, int * buff_hits);
extern "C" int PF_GetThisPage(int fd, int pagenum,char **pagebuf, int * buff_hits);
...
extern "C" int AM_InsertEntry(int fileDesc, char attrType, int attrLength, char *value, int recId,int * buff_hits,int * num_nodes,int * buff_access);
